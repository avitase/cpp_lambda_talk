...
\begin{frame}[fragile]{Let's talk about Python}
    \textbf{Q:} What is the output of the program?
...
\begin{frame}[fragile]{Q: What is the output of the program?}
    ...
    \only<2>{\textbf{A:} \texttt{234}}
\end{frame}

\begin{frame}[fragile]{Q: What is the output of the program?}
    \inputcpplisting{snippet34c}

    \only<2>{\textbf{A:} \texttt{555} (not \texttt{444})}
\end{frame}
